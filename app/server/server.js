...
server.on('request',function(req,res){
    ...
    customEvent.emit('data',{request:"request here",response:"response here"});
...
var customStream = Rx.Observable.fromEvent(customEvent,'data');

customStream.subscribe(function(d){
	console.log(d);
});
